              ...
              <div className="p-4" id="print">
                ...
                <div className="mt-6">
                  <div className="mb-4 grid grid-cols-2">
                    ...
                    <span className="font-bold">STS Ward No:</span>
                    <span>{invoiceInfo.selectedWardNumber}</span>
                    <span className="font-bold">Landill Site No:</span>
                    <span>{invoiceInfo.selectedSiteNumber}</span>
                  </div>
                  ...
                  <table className="w-full text-left">
                    <thead>
                      <tr className="border-y border-black/10 text-sm md:text-base">
                        ...
                        <th>Type</th>
                        <th>Capacity</th>
                        <th className="text-right">Loaded Fuel Cost</th>
                        <th className="text-right">Unloaded Fuel Cost</th>
                      </tr>
                    </thead>
                    <tbody>
                    {items.map((item) => (
      ...
      if (vehicle.regnumber === item.selectedVehicle) {
        return (
          <Fragment key={vehicle.regnumber}>
            ...
            <td className="text-right">${vehicle.loadedfuelcost}</td>
            <td className="text-right">${vehicle.unloadedfuelcost}</td>
